...
func tmplMonitorTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "tmpl/monitor.tmpl", size: 1517, mode: os.FileMode(420), modTime: time.Unix(1599282861, 0)}
...
func tmplScreenboardTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "tmpl/screenboard.tmpl", size: 8851, mode: os.FileMode(420), modTime: time.Unix(1599289123, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func tmplTimeboardTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "tmpl/timeboard.tmpl", size: 2267, mode: os.FileMode(420), modTime: time.Unix(1599282861, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
